...
<head>
  <title>Insight VMS Admin- All Contacts</title>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="heading-elements">
                 ...
                 <li><a href="#" name="export" id="export" class="text-success">Export</a></li>
                  </ul>
                </div>
              </div>
...
$sql ="SELECT FullName,EmailId,PhoneNumber,Temperature,Oxygen,PostingDate,Subject,Message,id,Is_Read from tblcontactdata";
...
foreach($results as $result):
       ?>
				  ...
				  <td><?php echo htmlentities($result->Temperature);?></td>
				  <td><?php echo htmlentities($result->Oxygen);?></td>
