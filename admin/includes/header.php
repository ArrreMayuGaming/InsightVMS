        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item mr-auto">
            <a class="navbar-brand" href="dashboard.php">
              ...
              <h3 class="brand-text">Insight VMS Admin</h3>
            </a>
          </li>
      ...
      <div class="navbar-container content">
        <div class="collapse navbar-collapse" id="navbar-mobile">
          <ul class="nav navbar-nav mr-auto float-left">
           ...
           <img src="app-assets/images/logo.jpeg" alt="avatar" height="55px" width="65px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
		    <div class="collapse navbar-collapse" id="navbar-mobile"><h2> <b>Insight Business Machines Pvt Ltd</b></h2></div>
            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                ...
                <span class="avatar avatar-online">
                  <img src="app-assets/images/adminimg.jpg" alt="avatar"><i></i></span>
              </a>
