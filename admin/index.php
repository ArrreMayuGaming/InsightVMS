...
data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="#">
              ...
              <h3 class="brand-text">Insight Visitor Management System </h3>
            </a>
          </li>
  ...
  <div class="app-content content">
    <div class="content-wrapper">
	  ...
	  <center><img src="app-assets/images/insight_logo_transparent.png" width="200" height="70"></center><br>
            ...
            <div class="col-md-4 col-10 box-shadow-2 p-0">
              <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                 ...
                 <h3><b>Insight Admin Login</b></h3>
                  </div>
                  <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                    <span>Inspire Lives</span>
                  </h6>
				  <div class="card-title text-center">
                 Enter Your Details
                  </div>
...
<button type="submit" class="btn btn-danger btn-block btn-lg" name="login"><i class="ft-unlock"></i> Login</button>
  ...
  <footer class="footer fixed-bottom footer-dark navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Designed by Jayesh, Mayuresh and Yash &copy; 2021 <a class="text-bold-800 grey darken-2" href="https://www.insightindia.com/"
        target="_blank">. Insight Business Machines Pvt Ltd</a> </span>
      <span class="float-md-right d-block d-md-inline-blockd-none d-lg-block">Inspire Lives! <i class="ft-heart pink"></i></span>
    </p>
  </footer>
  <!-- BEGIN VENDOR JS-->
