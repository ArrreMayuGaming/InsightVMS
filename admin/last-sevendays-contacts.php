...
<head>
  <title>Insight VMS Admin- Last seven days Contacts</title>
...
$sql = "SELECT FullName,EmailId,PhoneNumber,Temperature,Oxygen,PostingDate,Subject,Message,id,Is_Read from tblcontactdata where date(PostingDate)>= DATE(NOW()) - INTERVAL 7 DAY";
