...
<head>
  <title>Insight VMS Admin- Search Contact Details</title>
...
$sql = "SELECT PostingDate,FullName,PhoneNumber,Temperature,Message,Subject,Oxygen,id,Is_Read from tblcontactdata where date(PostingDate) between :fd and :td";
