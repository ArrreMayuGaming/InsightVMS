...
<head>
  <title>Insight VMS Admin- Todays Contacts</title>
...
$sql = "SELECT FullName,EmailId,PhoneNumber,Temperature,Oxygen,PostingDate,Subject,Message,id,Is_Read from tblcontactdata where date(PostingDate)=CURDATE()";
